// Generated from D:/UNI/Term6/PLC/CAs/testCA2/src/main/grammar/FunctionCraft.g4 by ANTLR 4.13.1
package parsers;
	...
	public final PatternMatchingContext patternMatching() throws RecognitionException {
		...
		try {
			...
			match(RPAR);
			        ...
			        Identifier id_1 = new Identifier((((PatternMatchingContext)_localctx).patternName!=null?((PatternMatchingContext)_localctx).patternName.getText():null));
			        id_1.setLine((((PatternMatchingContext)_localctx).patternName!=null?((PatternMatchingContext)_localctx).patternName.getLine():0));
			        Identifier id_2 = new Identifier((((PatternMatchingContext)_localctx).targetVar!=null?((PatternMatchingContext)_localctx).targetVar.getText():null));
			        id_2.setLine((((PatternMatchingContext)_localctx).targetVar!=null?((PatternMatchingContext)_localctx).targetVar.getLine():0));
			        ((PatternMatchingContext)_localctx).patternRet =  new PatternDeclaration(id_1, id_2);
			...
			while (_la==PATTERN_MATCHING_SEPARATOR) {
				...
				_localctx.patternRet.addCondition(((PatternMatchingContext)_localctx).c.conditionRet);
				setState(145);
				match(ASSIGN);
				setState(146);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					((ExpressionContext)_localctx).e2 = eqaulityExpression();
					                  ...
					                  AppendExpression appendExpression = new AppendExpression(((ExpressionContext)_localctx).e1.expRet);
					                  appendExpression.addAppendedExpression(((ExpressionContext)_localctx).e2.expRet);
					                  appendExpression.setLine((((ExpressionContext)_localctx).a!=null?((ExpressionContext)_localctx).a.getLine():0));
					                  ((ExpressionContext)_localctx).expRet =  appendExpression;
